...
class MyHomePage extends StatelessWidget {
  ...
  List<Station> stations = [
    Station(1, 'Tram 01', 'pulic', true, 20.1),
    Station(2, 'Tram 02', 'pulic', true, 20.2),
    Station(3, 'Tram 03', 'private', false, 20.3),
    Station(4, 'Tram 04', 'private', false, 20.4),
    Station(5, 'Tram 05', 'private', false, 20.5),
    Station(6, 'Tram 06', 'pulic', true, 20.6),
    Station(7, 'Tram 07', 'pulic', true, 20.7),
...
class StationDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: item.status ? Colors.green : Colors.black26,
